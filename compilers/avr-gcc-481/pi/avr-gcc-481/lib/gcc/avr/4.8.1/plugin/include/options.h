...
enum opt_code
{
  ...
  OPT_maccumulate_args = 1038,               /* -maccumulate-args */
  OPT_mbranch_cost_ = 1039,                  /* -mbranch-cost= */
  OPT_mcall_prologues = 1040,                /* -mcall-prologues */
  OPT_mdeb = 1041,                           /* -mdeb */
  OPT_mint8 = 1042,                          /* -mint8 */
  OPT_mlog_ = 1043,                          /* -mlog= */
  OPT_mmcu_ = 1044,                          /* -mmcu= */
  OPT_mno_interrupts = 1045,                 /* -mno-interrupts */
  OPT_morder1 = 1046,                        /* -morder1 */
  OPT_morder2 = 1047,                        /* -morder2 */
  OPT_mpmem_wrap_around = 1048,              /* -mpmem-wrap-around */
  OPT_mrelax = 1049,                         /* -mrelax */
  OPT_msp8 = 1050,                           /* -msp8 */
  OPT_mstrict_X = 1051,                      /* -mstrict-X */
  OPT_mtiny_stack = 1052,                    /* -mtiny-stack */
  OPT_n = 1053,                              /* -n */
  ...
  OPT_pie = 1068,                            /* -pie */
  OPT_pipe = 1069,                           /* -pipe */
  OPT_print_file_name_ = 1070,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1071,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1072,          /* -print-multi-directory */
  OPT_print_multi_lib = 1073,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1074,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1075,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1076,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1077,               /* -print-prog-name= */
  OPT_print_search_dirs = 1078,              /* -print-search-dirs */
  OPT_print_sysroot = 1079,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1080,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1081,                          /* -quiet */
  OPT_r = 1082,                              /* -r */
  OPT_remap = 1083,                          /* -remap */
  OPT_s = 1084,                              /* -s */
  OPT_s_bc_abi = 1085,                       /* -s-bc-abi */
  OPT_save_temps = 1086,                     /* -save-temps */
  OPT_save_temps_ = 1087,                    /* -save-temps= */
  OPT_shared = 1088,                         /* -shared */
  OPT_shared_libgcc = 1089,                  /* -shared-libgcc */
  /* OPT_specs = 1090, */                    /* -specs */
  OPT_specs_ = 1091,                         /* -specs= */
  OPT_static = 1092,                         /* -static */
  OPT_static_libasan = 1093,                 /* -static-libasan */
  OPT_static_libgcc = 1094,                  /* -static-libgcc */
  OPT_static_libgcj = 1095,                  /* -static-libgcj */
  OPT_static_libgfortran = 1096,             /* -static-libgfortran */
  OPT_static_libgo = 1097,                   /* -static-libgo */
  OPT_static_libstdc__ = 1098,               /* -static-libstdc++ */
  OPT_static_libtsan = 1099,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1100, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1101, */                /* -std=c++0x */
  OPT_std_c__11 = 1102,                      /* -std=c++11 */
  OPT_std_c__1y = 1103,                      /* -std=c++1y */
  OPT_std_c__98 = 1104,                      /* -std=c++98 */
  OPT_std_c11 = 1105,                        /* -std=c11 */
  /* OPT_std_c1x = 1106, */                  /* -std=c1x */
  /* OPT_std_c89 = 1107, */                  /* -std=c89 */
  OPT_std_c90 = 1108,                        /* -std=c90 */
  OPT_std_c99 = 1109,                        /* -std=c99 */
  /* OPT_std_c9x = 1110, */                  /* -std=c9x */
  OPT_std_f2003 = 1111,                      /* -std=f2003 */
  OPT_std_f2008 = 1112,                      /* -std=f2008 */
  OPT_std_f2008ts = 1113,                    /* -std=f2008ts */
  OPT_std_f95 = 1114,                        /* -std=f95 */
  OPT_std_gnu = 1115,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1116, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1117, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1118,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1119,                    /* -std=gnu++1y */
