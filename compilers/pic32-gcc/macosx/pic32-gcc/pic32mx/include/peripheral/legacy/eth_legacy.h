...
#if (__XC32_VERSION == 1000)
static __inline__ __attribute__((always_inline)) int __EthDescriptorsAdd ( int nDescriptors, eEthDcptType dType, pEthDcptAllocF fAlloc )
{
  __asm__ volatile (" .equ ___callocaddr, calloc \n");
  return EthDescriptorsAdd (nDescriptors, dType, fAlloc );
}
#undef EthDescriptorsAdd
#define EthDescriptorsAdd __EthDescriptorsAdd
#endif
