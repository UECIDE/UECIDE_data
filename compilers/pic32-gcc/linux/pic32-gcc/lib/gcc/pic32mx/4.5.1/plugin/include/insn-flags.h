...
#define HAVE_sibcall_internal (TARGET_SIBCALLS && SIBLING_CALL_P (insn) && (mchp_check_for_conversion(insn)))
#define HAVE_sibcall_value_internal (TARGET_SIBCALLS && SIBLING_CALL_P (insn) && (mchp_check_for_conversion(insn)) )
#define HAVE_sibcall_value_multiple_internal (TARGET_SIBCALLS && SIBLING_CALL_P (insn) && (mchp_check_for_conversion(insn)))
#define HAVE_call_internal ((mchp_check_for_conversion(insn)))
#define HAVE_call_split (TARGET_SPLIT_CALLS && (mchp_check_for_conversion(insn)))
#define HAVE_call_internal_direct ((mchp_check_for_conversion(insn)))
#define HAVE_call_direct_split (TARGET_SPLIT_CALLS && (mchp_check_for_conversion(insn)))
#define HAVE_call_value_internal ((mchp_check_for_conversion(insn)))
#define HAVE_call_value_split (TARGET_SPLIT_CALLS && (mchp_check_for_conversion(insn)))
#define HAVE_call_value_internal_direct ((mchp_check_for_conversion(insn)))
#define HAVE_call_value_direct_split (TARGET_SPLIT_CALLS && (mchp_check_for_conversion(insn)))
#define HAVE_call_value_multiple_internal ((mchp_check_for_conversion(insn)))
#define HAVE_call_value_multiple_split (TARGET_SPLIT_CALLS && (mchp_check_for_conversion(insn)))
...
#define HAVE_pic32_uniqueid 1
#define HAVE_pic32_uniqueid_32 (!TARGET_MIPS16)
#define HAVE_pic32_uniqueid_16 (TARGET_MIPS16)
...
extern rtx        gen_pic32_uniqueid                  (rtx, rtx, rtx);
extern rtx        gen_pic32_uniqueid_32               (rtx, rtx, rtx);
extern rtx        gen_pic32_uniqueid_16               (rtx, rtx, rtx);
...
static inline rtx gen_addv2hi3                        (rtx, rtx, rtx);
static inline rtx
gen_addv2hi3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_addv4qi3                        (rtx, rtx, rtx);
static inline rtx
gen_addv4qi3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_addq_s_w                   (rtx, rtx, rtx);
static inline rtx
gen_mips_addq_s_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_addq_s_ph                  (rtx, rtx, rtx);
static inline rtx
gen_mips_addq_s_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_addu_s_qb                  (rtx, rtx, rtx);
static inline rtx
gen_mips_addu_s_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_subv2hi3                        (rtx, rtx, rtx);
static inline rtx
gen_subv2hi3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_subv4qi3                        (rtx, rtx, rtx);
static inline rtx
gen_subv4qi3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_subq_s_w                   (rtx, rtx, rtx);
static inline rtx
gen_mips_subq_s_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_subq_s_ph                  (rtx, rtx, rtx);
static inline rtx
gen_mips_subq_s_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_subu_s_qb                  (rtx, rtx, rtx);
static inline rtx
gen_mips_subu_s_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_addsc                      (rtx, rtx, rtx);
static inline rtx
gen_mips_addsc(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_addwc                      (rtx, rtx, rtx);
static inline rtx
gen_mips_addwc(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_modsub                     (rtx, rtx, rtx);
static inline rtx
gen_mips_modsub(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_raddu_w_qb                 (rtx, rtx);
static inline rtx
gen_mips_raddu_w_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_absq_s_w                   (rtx, rtx);
static inline rtx
gen_mips_absq_s_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_absq_s_ph                  (rtx, rtx);
static inline rtx
gen_mips_absq_s_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_precrq_qb_ph               (rtx, rtx, rtx);
static inline rtx
gen_mips_precrq_qb_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_precrq_ph_w                (rtx, rtx, rtx);
static inline rtx
gen_mips_precrq_ph_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_precrq_rs_ph_w             (rtx, rtx, rtx);
static inline rtx
gen_mips_precrq_rs_ph_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_precrqu_s_qb_ph            (rtx, rtx, rtx);
static inline rtx
gen_mips_precrqu_s_qb_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_preceq_w_phl               (rtx, rtx);
static inline rtx
gen_mips_preceq_w_phl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_preceq_w_phr               (rtx, rtx);
static inline rtx
gen_mips_preceq_w_phr(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_precequ_ph_qbl             (rtx, rtx);
static inline rtx
gen_mips_precequ_ph_qbl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_precequ_ph_qbr             (rtx, rtx);
static inline rtx
gen_mips_precequ_ph_qbr(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_precequ_ph_qbla            (rtx, rtx);
static inline rtx
gen_mips_precequ_ph_qbla(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_precequ_ph_qbra            (rtx, rtx);
static inline rtx
gen_mips_precequ_ph_qbra(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_preceu_ph_qbl              (rtx, rtx);
static inline rtx
gen_mips_preceu_ph_qbl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_preceu_ph_qbr              (rtx, rtx);
static inline rtx
gen_mips_preceu_ph_qbr(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_preceu_ph_qbla             (rtx, rtx);
static inline rtx
gen_mips_preceu_ph_qbla(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_preceu_ph_qbra             (rtx, rtx);
static inline rtx
gen_mips_preceu_ph_qbra(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_shll_ph                    (rtx, rtx, rtx);
static inline rtx
gen_mips_shll_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_shll_qb                    (rtx, rtx, rtx);
static inline rtx
gen_mips_shll_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_shll_s_w                   (rtx, rtx, rtx);
static inline rtx
gen_mips_shll_s_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_shll_s_ph                  (rtx, rtx, rtx);
static inline rtx
gen_mips_shll_s_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_shrl_qb                    (rtx, rtx, rtx);
static inline rtx
gen_mips_shrl_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_shra_ph                    (rtx, rtx, rtx);
static inline rtx
gen_mips_shra_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_shra_r_w                   (rtx, rtx, rtx);
static inline rtx
gen_mips_shra_r_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_shra_r_ph                  (rtx, rtx, rtx);
static inline rtx
gen_mips_shra_r_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_muleu_s_ph_qbl             (rtx, rtx, rtx);
static inline rtx
gen_mips_muleu_s_ph_qbl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_muleu_s_ph_qbr             (rtx, rtx, rtx);
static inline rtx
gen_mips_muleu_s_ph_qbr(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_mulq_rs_ph                 (rtx, rtx, rtx);
static inline rtx
gen_mips_mulq_rs_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_muleq_s_w_phl              (rtx, rtx, rtx);
static inline rtx
gen_mips_muleq_s_w_phl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_muleq_s_w_phr              (rtx, rtx, rtx);
static inline rtx
gen_mips_muleq_s_w_phr(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_dpau_h_qbl                 (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpau_h_qbl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_dpau_h_qbr                 (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpau_h_qbr(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_dpsu_h_qbl                 (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpsu_h_qbl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_dpsu_h_qbr                 (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpsu_h_qbr(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_dpaq_s_w_ph                (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpaq_s_w_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_dpsq_s_w_ph                (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpsq_s_w_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_mulsaq_s_w_ph              (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_mulsaq_s_w_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_dpaq_sa_l_w                (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpaq_sa_l_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_dpsq_sa_l_w                (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpsq_sa_l_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_maq_s_w_phl                (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_maq_s_w_phl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_maq_s_w_phr                (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_maq_s_w_phr(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_maq_sa_w_phl               (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_maq_sa_w_phl(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_maq_sa_w_phr               (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_maq_sa_w_phr(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_bitrev                     (rtx, rtx);
static inline rtx
gen_mips_bitrev(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_insv                       (rtx, rtx, rtx);
static inline rtx
gen_mips_insv(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_repl_qb                    (rtx, rtx);
static inline rtx
gen_mips_repl_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_repl_ph                    (rtx, rtx);
static inline rtx
gen_mips_repl_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_cmp_eq_ph                  (rtx, rtx);
static inline rtx
gen_mips_cmp_eq_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_cmpu_eq_qb                 (rtx, rtx);
static inline rtx
gen_mips_cmpu_eq_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_cmp_lt_ph                  (rtx, rtx);
static inline rtx
gen_mips_cmp_lt_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_cmpu_lt_qb                 (rtx, rtx);
static inline rtx
gen_mips_cmpu_lt_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_cmp_le_ph                  (rtx, rtx);
static inline rtx
gen_mips_cmp_le_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_cmpu_le_qb                 (rtx, rtx);
static inline rtx
gen_mips_cmpu_le_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_cmpgu_eq_qb                (rtx, rtx, rtx);
static inline rtx
gen_mips_cmpgu_eq_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_cmpgu_lt_qb                (rtx, rtx, rtx);
static inline rtx
gen_mips_cmpgu_lt_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_cmpgu_le_qb                (rtx, rtx, rtx);
static inline rtx
gen_mips_cmpgu_le_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_pick_ph                    (rtx, rtx, rtx);
static inline rtx
gen_mips_pick_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_pick_qb                    (rtx, rtx, rtx);
static inline rtx
gen_mips_pick_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_packrl_ph                  (rtx, rtx, rtx);
static inline rtx
gen_mips_packrl_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_extr_w                     (rtx, rtx, rtx);
static inline rtx
gen_mips_extr_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_extr_r_w                   (rtx, rtx, rtx);
static inline rtx
gen_mips_extr_r_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_extr_rs_w                  (rtx, rtx, rtx);
static inline rtx
gen_mips_extr_rs_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_extr_s_h                   (rtx, rtx, rtx);
static inline rtx
gen_mips_extr_s_h(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_extp                       (rtx, rtx, rtx);
static inline rtx
gen_mips_extp(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_extpdp                     (rtx, rtx, rtx);
static inline rtx
gen_mips_extpdp(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_shilo                      (rtx, rtx, rtx);
static inline rtx
gen_mips_shilo(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_mthlip                     (rtx, rtx, rtx);
static inline rtx
gen_mips_mthlip(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_wrdsp                      (rtx, rtx);
static inline rtx
gen_mips_wrdsp(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_rddsp                      (rtx, rtx);
static inline rtx
gen_mips_rddsp(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_lbux_si                    (rtx, rtx, rtx);
static inline rtx
gen_mips_lbux_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_mips_lhx_si                     (rtx, rtx, rtx);
static inline rtx
gen_mips_lhx_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_mips_lwx_si                     (rtx, rtx, rtx);
static inline rtx
gen_mips_lwx_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_mips_bposge                     (rtx, rtx);
static inline rtx
gen_mips_bposge(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_absq_s_qb                  (rtx, rtx);
static inline rtx
gen_mips_absq_s_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_mips_addu_ph                    (rtx, rtx, rtx);
static inline rtx
gen_mips_addu_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_addu_s_ph                  (rtx, rtx, rtx);
static inline rtx
gen_mips_addu_s_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_adduh_qb                   (rtx, rtx, rtx);
static inline rtx
gen_mips_adduh_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_adduh_r_qb                 (rtx, rtx, rtx);
static inline rtx
gen_mips_adduh_r_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_append                     (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_append(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_balign                     (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_balign(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_cmpgdu_eq_qb               (rtx, rtx, rtx);
static inline rtx
gen_mips_cmpgdu_eq_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_cmpgdu_lt_qb               (rtx, rtx, rtx);
static inline rtx
gen_mips_cmpgdu_lt_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_cmpgdu_le_qb               (rtx, rtx, rtx);
static inline rtx
gen_mips_cmpgdu_le_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_dpa_w_ph                   (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpa_w_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_dps_w_ph                   (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dps_w_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mulv2hi3                        (rtx, rtx, rtx);
static inline rtx
gen_mulv2hi3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_mul_s_ph                   (rtx, rtx, rtx);
static inline rtx
gen_mips_mul_s_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_mulq_rs_w                  (rtx, rtx, rtx);
static inline rtx
gen_mips_mulq_rs_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_mulq_s_ph                  (rtx, rtx, rtx);
static inline rtx
gen_mips_mulq_s_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_mulq_s_w                   (rtx, rtx, rtx);
static inline rtx
gen_mips_mulq_s_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_mulsa_w_ph                 (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_mulsa_w_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_mult                       (rtx, rtx, rtx);
static inline rtx
gen_mips_mult(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_multu                      (rtx, rtx, rtx);
static inline rtx
gen_mips_multu(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_precr_qb_ph                (rtx, rtx, rtx);
static inline rtx
gen_mips_precr_qb_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_precr_sra_ph_w             (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_precr_sra_ph_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_precr_sra_r_ph_w           (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_precr_sra_r_ph_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_prepend                    (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_prepend(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_shra_qb                    (rtx, rtx, rtx);
static inline rtx
gen_mips_shra_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_shra_r_qb                  (rtx, rtx, rtx);
static inline rtx
gen_mips_shra_r_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_shrl_ph                    (rtx, rtx, rtx);
static inline rtx
gen_mips_shrl_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_subu_ph                    (rtx, rtx, rtx);
static inline rtx
gen_mips_subu_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_subu_s_ph                  (rtx, rtx, rtx);
static inline rtx
gen_mips_subu_s_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_subuh_qb                   (rtx, rtx, rtx);
static inline rtx
gen_mips_subuh_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_subuh_r_qb                 (rtx, rtx, rtx);
static inline rtx
gen_mips_subuh_r_qb(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_addqh_ph                   (rtx, rtx, rtx);
static inline rtx
gen_mips_addqh_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_addqh_r_ph                 (rtx, rtx, rtx);
static inline rtx
gen_mips_addqh_r_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_addqh_w                    (rtx, rtx, rtx);
static inline rtx
gen_mips_addqh_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_addqh_r_w                  (rtx, rtx, rtx);
static inline rtx
gen_mips_addqh_r_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_subqh_ph                   (rtx, rtx, rtx);
static inline rtx
gen_mips_subqh_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_subqh_r_ph                 (rtx, rtx, rtx);
static inline rtx
gen_mips_subqh_r_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_subqh_w                    (rtx, rtx, rtx);
static inline rtx
gen_mips_subqh_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_subqh_r_w                  (rtx, rtx, rtx);
static inline rtx
gen_mips_subqh_r_w(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_dpax_w_ph                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpax_w_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_dpsx_w_ph                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpsx_w_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_dpaqx_s_w_ph               (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpaqx_s_w_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_dpaqx_sa_w_ph              (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpaqx_sa_w_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_dpsqx_s_w_ph               (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpsqx_s_w_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_dpsqx_sa_w_ph              (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_dpsqx_sa_w_ph(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
...
static inline rtx gen_usadduqq3                       (rtx, rtx, rtx);
static inline rtx
gen_usadduqq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_usadduhq3                       (rtx, rtx, rtx);
static inline rtx
gen_usadduhq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_usadduha3                       (rtx, rtx, rtx);
static inline rtx
gen_usadduha3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_usaddv4uqq3                     (rtx, rtx, rtx);
static inline rtx
gen_usaddv4uqq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_usaddv2uhq3                     (rtx, rtx, rtx);
static inline rtx
gen_usaddv2uhq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_usaddv2uha3                     (rtx, rtx, rtx);
static inline rtx
gen_usaddv2uha3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ssaddhq3                        (rtx, rtx, rtx);
static inline rtx
gen_ssaddhq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ssaddsq3                        (rtx, rtx, rtx);
static inline rtx
gen_ssaddsq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ssaddha3                        (rtx, rtx, rtx);
static inline rtx
gen_ssaddha3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ssaddsa3                        (rtx, rtx, rtx);
static inline rtx
gen_ssaddsa3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ssaddv2hq3                      (rtx, rtx, rtx);
static inline rtx
gen_ssaddv2hq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ssaddv2ha3                      (rtx, rtx, rtx);
static inline rtx
gen_ssaddv2ha3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_ussubuqq3                       (rtx, rtx, rtx);
static inline rtx
gen_ussubuqq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ussubuhq3                       (rtx, rtx, rtx);
static inline rtx
gen_ussubuhq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ussubuha3                       (rtx, rtx, rtx);
static inline rtx
gen_ussubuha3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ussubv4uqq3                     (rtx, rtx, rtx);
static inline rtx
gen_ussubv4uqq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ussubv2uhq3                     (rtx, rtx, rtx);
static inline rtx
gen_ussubv2uhq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ussubv2uha3                     (rtx, rtx, rtx);
static inline rtx
gen_ussubv2uha3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_sssubhq3                        (rtx, rtx, rtx);
static inline rtx
gen_sssubhq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_sssubsq3                        (rtx, rtx, rtx);
static inline rtx
gen_sssubsq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_sssubha3                        (rtx, rtx, rtx);
static inline rtx
gen_sssubha3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_sssubsa3                        (rtx, rtx, rtx);
static inline rtx
gen_sssubsa3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_sssubv2hq3                      (rtx, rtx, rtx);
static inline rtx
gen_sssubv2hq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_sssubv2ha3                      (rtx, rtx, rtx);
static inline rtx
gen_sssubv2ha3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ssmulv2hq3                      (rtx, rtx, rtx);
static inline rtx
gen_ssmulv2hq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ssmulhq3                        (rtx, rtx, rtx);
static inline rtx
gen_ssmulhq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ssmulsq3                        (rtx, rtx, rtx);
static inline rtx
gen_ssmulsq3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ssmaddsqdq4                     (rtx, rtx, rtx, rtx);
static inline rtx
gen_ssmaddsqdq4(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_ssmsubsqdq4                     (rtx, rtx, rtx, rtx);
static inline rtx
gen_ssmsubsqdq4(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
...
static inline rtx gen_movv2hi                         (rtx, rtx);
static inline rtx
gen_movv2hi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_movv4qi                         (rtx, rtx);
static inline rtx
gen_movv4qi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_movv2hq                         (rtx, rtx);
static inline rtx
gen_movv2hq(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_movv2uhq                        (rtx, rtx);
static inline rtx
gen_movv2uhq(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_movv2ha                         (rtx, rtx);
static inline rtx
gen_movv2ha(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_movv2uha                        (rtx, rtx);
static inline rtx
gen_movv2uha(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_movv4qq                         (rtx, rtx);
static inline rtx
gen_movv4qq(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_movv4uqq                        (rtx, rtx);
static inline rtx
gen_movv4uqq(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
...
static inline rtx gen_mips_lbux                       (rtx, rtx, rtx);
static inline rtx
gen_mips_lbux(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_lhx                        (rtx, rtx, rtx);
static inline rtx
gen_mips_lhx(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_lwx                        (rtx, rtx, rtx);
static inline rtx
gen_mips_lwx(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_mips_madd                       (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_madd(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_maddu                      (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_maddu(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_msub                       (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_msub(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_mips_msubu                      (rtx, rtx, rtx, rtx);
static inline rtx
gen_mips_msubu(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
