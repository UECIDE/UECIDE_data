...
extern int TARGET_NOLINK_PERIPHERAL_LIBS;
...
#define MASK_EXPLICIT_RELOCS (1 << 5)
#define MASK_FIX_R10000 (1 << 6)
#define MASK_FIX_R4000 (1 << 7)
#define MASK_FIX_R4400 (1 << 8)
#define MASK_FP_EXCEPTIONS (1 << 9)
#define MASK_FUSED_MADD (1 << 10)
#define MASK_MIPS16 (1 << 11)
#define MASK_LLSC (1 << 12)
#define MASK_LONG64 (1 << 13)
#define MASK_MCU (1 << 14)
#define MASK_MEMCPY (1 << 15)
#define MASK_MICROMIPS (1 << 16)
#define MASK_RELAX_PIC_CALLS (1 << 17)
#define MASK_SOFT_FLOAT_ABI (1 << 18)
#define MASK_SPLIT_ADDRESSES (1 << 19)
#define MASK_SYNCI (1 << 20)
...
enum opt_code
{
  ...
  OPT_mno_peripheral_libs,                   /* -mno-peripheral-libs */
  OPT_mplt,                                  /* -mplt */
